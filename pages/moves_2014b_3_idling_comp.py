...
layout = dbc.Container(
    [
        ...
        dbc.Row(
            dbc.Card(
                html.H4(
                    "El Paso MOVES 2014b vs. 3 Idling Emission Comparison "
        ...
        dbc.Row(
                dbc.Col(
                    dcc.Graph(
                        id="erlt_comp_line_idle", style={"width": "100%", "height": "400px"}
                    ),
...
@app.callback(Output("fuel-radio-idle", "options"), Input("sut-radio", "value"))
...
@app.callback(Output("fuel-radio-idle", "value"), Input("fuel-radio-idle", "options"))
def set_fuel_value(available_options):
    return available_options[0]["value"]


@app.callback(
    Output("erlt_comp_line_idle", "figure"),
    [
        Input("sut-radio", "value"),
        Input("fuel-radio-idle", "value"),
