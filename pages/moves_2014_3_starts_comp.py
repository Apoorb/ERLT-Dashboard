...
rename_map = {
    ...
    "rate_per_start": "Starts Emission Rate (grams/starts)",
}
...
title_1 = html.H3("MOVES 2014b vs. MOVES 3 Starts Emission Comparison")
...
layout = dbc.Container(
    [
        ...
        dbc.Row(
            dbc.Card(
                html.H4(
                    "El Paso MOVES 2014b vs. 3 Starts Emission Comparison "
        ...
        dbc.Row(
            dbc.Card(
                html.H4(
                    "El Paso MOVES 2014b vs. 3 Starts Emission "
...
@app.callback(Output("fuel-radio-st", "options"), Input("sut-radio", "value"))
...
@app.callback(Output("fuel-radio-st", "value"), Input("fuel-radio-st", "options"))
def set_fuel_value(available_options):
    return available_options[0]["value"]


@app.callback(
    Output("erlt_comp_line_st", "figure"),
    [
        Input("sut-radio", "value"),
        Input("fuel-radio-st", "value"),
